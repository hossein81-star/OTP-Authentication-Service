...
from .views.profile_api import MyProfileViewApi
...
urlpatterns = [
    ...
    path("user_logout/",UserLogoutAPI.as_view(), name='user-logout'),
    path("user_profile/",MyProfileViewApi.as_view(), name='user-profile'),
